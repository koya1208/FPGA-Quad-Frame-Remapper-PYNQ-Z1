...
module quad_frame_remapper_quad_frame_remapper_Pipeline_7 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] exitcond2713_fu_97_p2;
...
wire   [63:0] loop_index_cast_fu_109_p1;
wire    ap_block_pp0_stage0;
wire    ap_block_pp0_stage0_01001_grp1;
reg   [8:0] loop_index_fu_54;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((exitcond2713_fu_97_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            loop_index_fu_54 <= empty_fu_103_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            loop_index_fu_54 <= 9'd0;
        end
    end
end
...
always @ (*) begin
    if (((exitcond2713_fu_97_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign empty_fu_103_p2 = (ap_sig_allocacmp_loop_index_load + 9'd1);

assign exitcond2713_fu_97_p2 = ((ap_sig_allocacmp_loop_index_load == 9'd360) ? 1'b1 : 1'b0);

assign line_buf_out_address0 = loop_index_cast_fu_109_p1;

assign line_buf_out_ce0 = line_buf_out_ce0_local;

assign loop_index_cast_fu_109_p1 = ap_sig_allocacmp_loop_index_load;
...
endmodule //quad_frame_remapper_quad_frame_remapper_Pipeline_7
