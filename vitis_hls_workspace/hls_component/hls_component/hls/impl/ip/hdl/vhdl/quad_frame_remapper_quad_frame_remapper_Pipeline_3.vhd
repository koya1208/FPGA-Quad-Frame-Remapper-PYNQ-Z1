...
entity quad_frame_remapper_quad_frame_remapper_Pipeline_3 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of quad_frame_remapper_quad_frame_remapper_Pipeline_3 is 
...
attribute shreg_extract : string;
    ...
    signal exitcond9_fu_90_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal loop_index5_load_reg_129_pp0_iter1_reg : STD_LOGIC_VECTOR (8 downto 0);
    signal gmem0_addr_read_reg_138 : STD_LOGIC_VECTOR (127 downto 0);
    signal loop_index5_cast_fu_113_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp0_stage0_grp0 : BOOLEAN;
    signal loop_index5_fu_50 : STD_LOGIC_VECTOR (8 downto 0) := "000000000";
    signal empty_fu_96_p2 : STD_LOGIC_VECTOR (8 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_loop_index5_load : STD_LOGIC_VECTOR (8 downto 0);
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal line_buf_in_we0_local : STD_LOGIC;
...
begin
    ...
    loop_index5_fu_50_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((exitcond9_fu_90_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                    loop_index5_fu_50 <= empty_fu_96_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    loop_index5_fu_50 <= ap_const_lv9_0;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                loop_index5_load_reg_129 <= ap_sig_allocacmp_loop_index5_load;
                loop_index5_load_reg_129_pp0_iter1_reg <= loop_index5_load_reg_129;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001_grp1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                gmem0_addr_read_reg_138 <= m_axi_gmem0_0_RDATA;
            end if;
        end if;
    end process;
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, exitcond9_fu_90_p2)
    begin
        if (((exitcond9_fu_90_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    ap_sig_allocacmp_loop_index5_load_assign_proc : process(ap_CS_fsm_pp0_stage0, loop_index5_fu_50, ap_loop_init, ap_block_pp0_stage0)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
            ap_sig_allocacmp_loop_index5_load <= ap_const_lv9_0;
        else 
            ap_sig_allocacmp_loop_index5_load <= loop_index5_fu_50;
        end if; 
    end process;

    empty_fu_96_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_loop_index5_load) + unsigned(ap_const_lv9_1));
    exitcond9_fu_90_p2 <= "1" when (ap_sig_allocacmp_loop_index5_load = ap_const_lv9_168) else "0";
    ...
    line_buf_in_address0 <= loop_index5_cast_fu_113_p1(9 - 1 downto 0);
    line_buf_in_ce0 <= line_buf_in_ce0_local;

    line_buf_in_ce0_local_assign_proc : process(ap_enable_reg_pp0_iter2, ap_block_pp0_stage0_11001_grp0, ap_block_pp0_stage0_subdone_grp0_done_reg)
    begin
    ...
    line_buf_in_d0 <= gmem0_addr_read_reg_138;
    line_buf_in_we0 <= line_buf_in_we0_local;

    line_buf_in_we0_local_assign_proc : process(ap_enable_reg_pp0_iter2, ap_block_pp0_stage0_11001_grp0, ap_block_pp0_stage0_subdone_grp0_done_reg)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_subdone_grp0_done_reg) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001_grp0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1))) then 
            line_buf_in_we0_local <= ap_const_logic_1;
        else 
            line_buf_in_we0_local <= ap_const_logic_0;
        end if; 
    end process;

    loop_index5_cast_fu_113_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(loop_index5_load_reg_129_pp0_iter1_reg),64));
