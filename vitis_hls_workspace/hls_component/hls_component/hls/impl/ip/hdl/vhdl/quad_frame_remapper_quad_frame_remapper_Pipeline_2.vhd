...
entity quad_frame_remapper_quad_frame_remapper_Pipeline_2 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of quad_frame_remapper_quad_frame_remapper_Pipeline_2 is 
...
attribute shreg_extract : string;
    ...
    signal exitcond2915_fu_97_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal line_buf_out_load_reg_146 : STD_LOGIC_VECTOR (127 downto 0);
    signal loop_index8_cast_fu_109_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal ap_block_pp0_stage0_01001_grp1 : BOOLEAN;
    signal loop_index8_fu_54 : STD_LOGIC_VECTOR (8 downto 0) := "000000000";
    signal empty_fu_103_p2 : STD_LOGIC_VECTOR (8 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_loop_index8_load : STD_LOGIC_VECTOR (8 downto 0);
...
begin
    ...
    loop_index8_fu_54_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((exitcond2915_fu_97_p2 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
                    loop_index8_fu_54 <= empty_fu_103_p2;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
                    loop_index8_fu_54 <= ap_const_lv9_0;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                line_buf_out_load_reg_146 <= line_buf_out_q0;
            end if;
        end if;
    end process;
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, exitcond2915_fu_97_p2)
    begin
        if (((exitcond2915_fu_97_p2 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    ap_sig_allocacmp_loop_index8_load_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, loop_index8_fu_54, ap_loop_init)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
            ap_sig_allocacmp_loop_index8_load <= ap_const_lv9_0;
        else 
            ap_sig_allocacmp_loop_index8_load <= loop_index8_fu_54;
        end if; 
    end process;

    empty_fu_103_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_loop_index8_load) + unsigned(ap_const_lv9_1));
    exitcond2915_fu_97_p2 <= "1" when (ap_sig_allocacmp_loop_index8_load = ap_const_lv9_168) else "0";
    ...
    line_buf_out_address0 <= loop_index8_cast_fu_109_p1(9 - 1 downto 0);
    line_buf_out_ce0 <= line_buf_out_ce0_local;

    line_buf_out_ce0_local_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_11001)
    begin
    ...
    loop_index8_cast_fu_109_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_loop_index8_load),64));
    ...
    m_axi_gmem1_0_WDATA <= line_buf_out_load_reg_146;
