...
module quad_frame_remapper_quad_frame_remapper_Pipeline_3 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
input  [59:0] sext_ln123;
output  [8:0] line_buf_in_address0;
output   line_buf_in_ce0;
output   line_buf_in_we0;
output  [127:0] line_buf_in_d0;
...
reg   [8:0] loop_index5_load_reg_129;
reg    ap_block_pp0_stage0_11001;
reg   [8:0] loop_index5_load_reg_129_pp0_iter1_reg;
reg   [127:0] gmem0_addr_read_reg_138;
wire   [63:0] loop_index5_cast_fu_113_p1;
wire    ap_block_pp0_stage0_grp0;
reg   [8:0] loop_index5_fu_50;
wire   [8:0] empty_fu_96_p2;
wire    ap_loop_init;
reg   [8:0] ap_sig_allocacmp_loop_index5_load;
wire    ap_block_pp0_stage0;
reg    line_buf_in_we0_local;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((exitcond9_fu_90_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            loop_index5_fu_50 <= empty_fu_96_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            loop_index5_fu_50 <= 9'd0;
        end
    end
end
...
always @ (*) begin
    if (((exitcond9_fu_90_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ap_sig_allocacmp_loop_index5_load = 9'd0;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone_grp0_done_reg) & (1'b0 == ap_block_pp0_stage0_11001_grp0) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
        line_buf_in_we0_local = 1'b1;
    end else begin
        line_buf_in_we0_local = 1'b0;
    end
end
...
assign empty_fu_96_p2 = (ap_sig_allocacmp_loop_index5_load + 9'd1);

assign exitcond9_fu_90_p2 = ((ap_sig_allocacmp_loop_index5_load == 9'd360) ? 1'b1 : 1'b0);

assign line_buf_in_address0 = loop_index5_cast_fu_113_p1;

assign line_buf_in_ce0 = line_buf_in_ce0_local;

assign line_buf_in_d0 = gmem0_addr_read_reg_138;

assign line_buf_in_we0 = line_buf_in_we0_local;

assign loop_index5_cast_fu_113_p1 = loop_index5_load_reg_129_pp0_iter1_reg;
...
endmodule //quad_frame_remapper_quad_frame_remapper_Pipeline_3
