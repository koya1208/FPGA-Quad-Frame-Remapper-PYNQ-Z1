...
module quad_frame_remapper_quad_frame_remapper_Pipeline_2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] exitcond2915_fu_97_p2;
...
reg   [127:0] line_buf_out_load_reg_146;
wire   [63:0] loop_index8_cast_fu_109_p1;
wire    ap_block_pp0_stage0;
wire    ap_block_pp0_stage0_01001_grp1;
reg   [8:0] loop_index8_fu_54;
wire   [8:0] empty_fu_103_p2;
wire    ap_loop_init;
reg   [8:0] ap_sig_allocacmp_loop_index8_load;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((exitcond2915_fu_97_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            loop_index8_fu_54 <= empty_fu_103_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            loop_index8_fu_54 <= 9'd0;
        end
    end
end
...
always @ (*) begin
    if (((exitcond2915_fu_97_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ap_sig_allocacmp_loop_index8_load = 9'd0;
    end else begin
...
assign empty_fu_103_p2 = (ap_sig_allocacmp_loop_index8_load + 9'd1);

assign exitcond2915_fu_97_p2 = ((ap_sig_allocacmp_loop_index8_load == 9'd360) ? 1'b1 : 1'b0);

assign line_buf_out_address0 = loop_index8_cast_fu_109_p1;

assign line_buf_out_ce0 = line_buf_out_ce0_local;

assign loop_index8_cast_fu_109_p1 = ap_sig_allocacmp_loop_index8_load;
...
assign m_axi_gmem1_0_WDATA = line_buf_out_load_reg_146;
...
endmodule //quad_frame_remapper_quad_frame_remapper_Pipeline_2
