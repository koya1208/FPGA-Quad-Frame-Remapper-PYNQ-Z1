...
HLS_SOURCES = ../../../../../../quad_frame_remapper_tb.cpp ../../../../../../quad_frame_remapper.cpp
...
$(ObjDir)/quad_frame_remapper_tb.o: ../../../../../../quad_frame_remapper_tb.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../../../quad_frame_remapper_tb.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/quad_frame_remapper_tb.d

$(ObjDir)/quad_frame_remapper.o: ../../../../../../quad_frame_remapper.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../../../quad_frame_remapper.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/quad_frame_remapper.d
