set moduleName quad_frame_remapper_Pipeline_7
set isTopModule 0
...
set cdfgNum 10
set C_modelName {quad_frame_remapper_Pipeline_7}
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 128, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "dst","offset": { "type": "dynamic","port_name": "dst","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "sext_ln160", "interface" : "wire", "bitwidth" : 60, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln160 sc_in sc_lv 60 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln160", "direction": "in", "datatype": "sc_lv", "bitwidth":60, "type": "signal", "bundle":{"name": "sext_ln160", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	sext_ln160 { ap_none {  { sext_ln160 in_data 0 60 } } }
