set moduleName quad_frame_remapper
set isTopModule 1
...
set cdfgNum 10
set C_modelName {quad_frame_remapper}
...
set C_modelArgList {
	...
	{ size_in_16bytes int 32 unused {axi_slave 0}  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 128, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "src","offset": { "type": "dynamic","port_name": "src","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 128, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "dst","offset": { "type": "dynamic","port_name": "dst","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	...
 	{ "Name" : "size_in_16bytes", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "offset" : {"in":40}, "offset_end" : {"in":47}} ]}
...
set NewPortList {[ 
	{ "name": "s_axi_control_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "control", "role": "AWADDR" },"address":[{"name":"quad_frame_remapper","role":"start","value":"0","valid_bit":"0"},{"name":"quad_frame_remapper","role":"continue","value":"0","valid_bit":"4"},{"name":"quad_frame_remapper","role":"auto_start","value":"0","valid_bit":"7"},{"name":"src","role":"data","value":"16"},{"name":"dst","role":"data","value":"28"},{"name":"size_in_16bytes","role":"data","value":"40"}] },
	...
	{ "name": "s_axi_control_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "control", "role": "ARADDR" },"address":[{"name":"quad_frame_remapper","role":"start","value":"0","valid_bit":"0"},{"name":"quad_frame_remapper","role":"done","value":"0","valid_bit":"1"},{"name":"quad_frame_remapper","role":"idle","value":"0","valid_bit":"2"},{"name":"quad_frame_remapper","role":"ready","value":"0","valid_bit":"3"},{"name":"quad_frame_remapper","role":"auto_start","value":"0","valid_bit":"7"}] },
...
set ArgLastReadFirstWriteLatency {
	quad_frame_remapper {
		...
		gmem1 {Type O LastRead 21 FirstWrite 2}
		src {Type I LastRead 0 FirstWrite -1}
		dst {Type I LastRead 0 FirstWrite -1}
		size_in_16bytes {Type I LastRead -1 FirstWrite -1}}
	quad_frame_remapper_Pipeline_1 {
		line_buf_out {Type O LastRead -1 FirstWrite 0}}
	...
	quad_frame_remapper_Pipeline_7 {
		...
		line_buf_out {Type I LastRead 0 FirstWrite -1}}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "794881", "Max" : "5798521"}
	, {"Name" : "Interval", "Min" : "794882", "Max" : "5798522"}
]}
...
dict set maxi_interface_dict gmem0 { CHANNEL_NUM 0 BUNDLE gmem0 NUM_READ_OUTSTANDING 4 NUM_WRITE_OUTSTANDING 16 MAX_READ_BURST_LENGTH 256 MAX_WRITE_BURST_LENGTH 16 READ_WRITE_MODE READ_ONLY}
dict set maxi_interface_dict gmem1 { CHANNEL_NUM 0 BUNDLE gmem1 NUM_READ_OUTSTANDING 16 NUM_WRITE_OUTSTANDING 2 MAX_READ_BURST_LENGTH 16 MAX_WRITE_BURST_LENGTH 32 READ_WRITE_MODE WRITE_ONLY}
