# 1 "C:/quad_frame_remapper/quad_frame_remapper.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 396 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "C:/quad_frame_remapper/quad_frame_remapper.cpp" 2
# 36 "C:/quad_frame_remapper/quad_frame_remapper.cpp"
...
# 37 "C:/quad_frame_remapper/quad_frame_remapper.cpp" 2
...
#pragma pack(pop)
# 10 "C:/Xilinx/2025.1/Vitis/tps/mingw/8.3.0/win64.o/nt\\x86_64-w64-mingw32\\include\\string.h" 2 3
...
# 38 "C:/quad_frame_remapper/quad_frame_remapper.cpp" 2

extern "C" {
# 48 "C:/quad_frame_remapper/quad_frame_remapper.cpp"
__attribute__((sdx_kernel("quad_frame_remapper", 0))) void quad_frame_remapper(
    ap_uint<128>* src,
    ap_uint<128>* dst,
    int size_in_16bytes
) {
#line 1 "directive"
#pragma HLSDIRECTIVE TOP name=quad_frame_remapper
# 52 "C:/quad_frame_remapper/quad_frame_remapper.cpp"
...
#pragma HLS INTERFACE s_axilite port=return bundle=control
 ...
 const int WIDTH = 1920;
    ...
    const int BYTES_PP = 3;
    const int STRIDE = WIDTH * BYTES_PP;
    const int WIDTH_WORDS = STRIDE / 16;
    ...
    const int MARGIN_X = (Q_W - SCALED_W) / 2;
    const int MARGIN_Y = (Q_H - SCALED_H) / 2;
    ...
    VITIS_LOOP_91_1: for (int y = 0; y < HEIGHT; y++) {
        ...
        VITIS_LOOP_132_2: for (int i = 0; i < SCALED_W; i++) {
        ...
        VITIS_LOOP_146_3: for (int i = 0; i < SCALED_W; i++) {

            int src_x = Q_W + ((i * 10) / 8);
