...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir O \
    corename line_buf_in \
    op interface \
    ports { line_buf_in_address0 { O 9 vector } line_buf_in_ce0 { O 1 bit } line_buf_in_we0 { O 1 bit } line_buf_in_d0 { O 128 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'line_buf_in'"
}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_sext_ln123 \
    op interface \
    ports { sext_ln123 { I 60 vector } } \
} "
}
