set moduleName quad_frame_remapper_Pipeline_2
set isTopModule 0
...
set cdfgNum 10
set C_modelName {quad_frame_remapper_Pipeline_2}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict line_buf_out { MEM_WIDTH 128 MEM_SIZE 5760 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	{ gmem1 int 128 regular {axi_master 1}  }
	{ sext_ln107 int 60 regular  }
	{ line_buf_out int 128 regular {array 360 { 1 3 } 1 1 }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 128, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "dst","offset": { "type": "dynamic","port_name": "dst","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "sext_ln107", "interface" : "wire", "bitwidth" : 60, "direction" : "READONLY"} , 
 	{ "Name" : "line_buf_out", "interface" : "memory", "bitwidth" : 128, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ sext_ln107 sc_in sc_lv 60 signal 1 } 
	{ line_buf_out_address0 sc_out sc_lv 9 signal 2 } 
	{ line_buf_out_ce0 sc_out sc_logic 1 signal 2 } 
	{ line_buf_out_q0 sc_in sc_lv 128 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln107", "direction": "in", "datatype": "sc_lv", "bitwidth":60, "type": "signal", "bundle":{"name": "sext_ln107", "role": "default" }} , 
 	...
 	{ "name": "line_buf_out_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "line_buf_out", "role": "q0" }}  ]}
...
set Spec2ImplPortList { 
	...
	sext_ln107 { ap_none {  { sext_ln107 in_data 0 60 } } }
	line_buf_out { ap_memory {  { line_buf_out_address0 mem_address 1 9 }  { line_buf_out_ce0 mem_ce 1 1 }  { line_buf_out_q0 mem_dout 0 128 } } }
}
