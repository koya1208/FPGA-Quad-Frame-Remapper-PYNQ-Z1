...
HD_PWD='C:/quad_frame_remapper/quad_frame_remapper.runs/project1_axi_interconnect_0_imp_auto_cc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log project1_axi_interconnect_0_imp_auto_cc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source project1_axi_interconnect_0_imp_auto_cc_0.tcl
