...
HD_PWD='C:/quad_frame_remapper/quad_frame_remapper.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log project1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source project1_wrapper.tcl -notrace
