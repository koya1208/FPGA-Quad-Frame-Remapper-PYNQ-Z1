...
HD_PWD='C:/quad_frame_remapper/quad_frame_remapper.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log project1_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source project1_wrapper.tcl
