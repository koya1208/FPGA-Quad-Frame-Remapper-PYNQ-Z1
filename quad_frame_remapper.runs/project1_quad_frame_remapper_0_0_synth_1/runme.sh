...
HD_PWD='C:/quad_frame_remapper/quad_frame_remapper.runs/project1_quad_frame_remapper_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log project1_quad_frame_remapper_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source project1_quad_frame_remapper_0_0.tcl
