# 1 "C:\\quad_frame_remapper\\vitis_embrdded_workspace\\platform\\hw\\sdt\\system-top.dts"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:\\quad_frame_remapper\\vitis_embrdded_workspace\\platform\\hw\\sdt\\system-top.dts"
/dts-v1/;
# 1 "C:\\quad_frame_remapper\\vitis_embrdded_workspace\\platform\\hw\\sdt\\zynq-7000.dtsi" 1
# 10 "C:\\quad_frame_remapper\\vitis_embrdded_workspace\\platform\\hw\\sdt\\zynq-7000.dtsi"
/ {
 #address-cells = <1>;
 #size-cells = <1>;
...
# 3 "C:\\quad_frame_remapper\\vitis_embrdded_workspace\\platform\\hw\\sdt\\system-top.dts" 2
# 1 "C:\\quad_frame_remapper\\vitis_embrdded_workspace\\platform\\hw\\sdt\\pl.dtsi" 1
/ {
 amba_pl: amba_pl {
  ranges;
  compatible = "simple-bus";
  #address-cells = <1>;
  #size-cells = <1>;
  firmware-name = "project1_wrapper.bit.bin";
  clocking2: clocking2 {
  ...
  clocking1: clocking1 {
   ...
   assigned-clock-rates = <142000000>;
   #clock-cells = <0>;
   clock-output-names = "fabric_clk";
   clocks = <&clkc 16>;
  };
  ...
  axi_vdma_0: dma@43000000 {
   ...
   xlnx,s2mm-max-burst-length = <128>;
   ...
   xlnx,mm2s-max-burst-length = <128>;
   status = "okay";
   ...
   xlnx,s2mm-linebuffer-depth = <0x1000>;
   xlnx,include-s2mm = <0x1>;
   xlnx,addr-width = <32>;
   clocks = <&clkc 16>, <&clkc 16>, <&clkc 16>, <&clkc 15>, <&clkc 16>;
   ...
   xlnx,mm2s-linebuffer-depth = <0x1000>;
  ...
  quad_frame_remapper_0: quad_frame_remapper@40000000 {
   compatible = "xlnx,quad-frame-remapper-1.0";
   xlnx,ii = "794882 , ~ , 5798522";
   xlnx,machine = <64>;
   xlnx,s-axi-control-addr-width = <6>;
   xlnx,ip-name = "quad_frame_remapper";
   ...
   xlnx,latency = <794881>;
   xlnx,name = "quad_frame_remapper_0";
  };
  v_tc_in: v_tc_0@43c00000 {
   xlnx,gen-vsync-en = <1>;
   xlnx,gen-hframe-size = <1650>;
   xlnx,num-fsyncs = <1>;
   xlnx,gen-hactive-size = <1280>;
   xlnx,gen-video-format = <2>;
   xlnx,gen-f1-vblank-hstart = <1390>;
   ...
   xlnx,enable-detection;
   xlnx,gen-cparity = <0>;
   xlnx,edk-iptype = "PERIPHERAL";
   xlnx,vertical-sync-generation;
   xlnx,gen-f1-vblank-hend = <1390>;
   xlnx,det-vsync-en = <1>;
   ...
   xlnx,gen-f1-vsync-hstart = <1390>;
   xlnx,gen-f0-vsync-hend = <1280>;
  };
  v_tc_out: v_tc_1@43c10000 {
   xlnx,gen-vsync-en = <1>;
   xlnx,gen-hframe-size = <2200>;
   xlnx,num-fsyncs = <1>;
   xlnx,gen-hactive-size = <1920>;
   xlnx,gen-video-format = <2>;
   xlnx,gen-f1-vblank-hstart = <2008>;
   xlnx,active-video-detection;
   xlnx,horizontal-sync-generation;
   xlnx,gen-vblank-en = <1>;
   xlnx,gen-avideo-en = <1>;
   ...
   compatible = "xlnx,v-tc-6.2" , "xlnx,v-tc-6.1" , "xlnx,bridge-v-tc-6.1";
   xlnx,max-clocks-per-line = <4096>;
   xlnx,gen-f0-vframe-size = <1125>;
   xlnx,gen-f0-vblank-hstart = <2008>;
   xlnx,max-lines = <4096>;
   xlnx,gen-f0-vsync-vstart = <1083>;
   xlnx,horizontal-blank-generation;
   xlnx,gen-hsync-end = <2052>;
   xlnx,gen-f0-vsync-hstart = <2008>;
   xlnx,gen-f1-vsync-hend = <2008>;
   xlnx,vertical-blank-detection;
   xlnx,gen-vsync-polarity = <1>;
   xlnx,fsync-vstart0 = <0>;
   xlnx,gen-hsync-polarity = <1>;
   ...
   status = "okay";
   xlnx,fsync-vstart2 = <0>;
   xlnx,gen-hsync-start = <2008>;
   xlnx,gen-f0-vsync-vend = <1088>;
   xlnx,fsync-vstart3 = <0>;
   xlnx,vertical-sync-detection;
   xlnx,frame-syncs = <1>;
   xlnx,fsync-vstart4 = <0>;
   xlnx,gen-vactive-size = <1080>;
   xlnx,name = "v_tc_out";
   xlnx,fsync-vstart5 = <0>;
   xlnx,gen-achroma-en = <0>;
   xlnx,fsync-vstart6 = <0>;
   ...
   xlnx,det-achroma-en = <0>;
   xlnx,generator;
   xlnx,gen-f1-vsync-vstart = <1083>;
   xlnx,vertical-blank-generation;
   xlnx,gen-hblank-polarity = <1>;
   xlnx,video-mode = "1080p";
   xlnx,gen-fieldid-polarity = <1>;
   xlnx,gen-f1-vsync-hstart = <2008>;
   xlnx,gen-f0-vsync-hend = <2008>;
  };
 };
};
# 4 "C:\\quad_frame_remapper\\vitis_embrdded_workspace\\platform\\hw\\sdt\\system-top.dts" 2
# 1 "C:\\quad_frame_remapper\\vitis_embrdded_workspace\\platform\\hw\\sdt\\pcw.dtsi" 1
 &ps7_cortexa9_0 {
 ...
 &amba {
  processing_system7_0: processing_system7@0 {
   ...
   xlnx,pcw-act-fpga1-peripheral-freqmhz = <0x883d3ac>;
   ...
   xlnx,pcw-fclk1-peripheral-divisor0 = <7>;
   ...
   xlnx,pcw-s-axi-hp0-freqmhz = <142>;
   ...
   xlnx,pcw-fpga1-peripheral-freqmhz = <142>;
...
# 5 "C:\\quad_frame_remapper\\vitis_embrdded_workspace\\platform\\hw\\sdt\\system-top.dts" 2
/ {
 board = "pynq-z1";
 compatible = "xlnx,pynq-z1";
 device_id = "7z020";
 slrcount = <1>;
 family = "Zynq";
 speed_grade = "1";
 ...
 cpus_a9: cpus-a9@0 {
  ...
  address-map = <0xf0000000 &amba 0xf0000000 0x10000000>,
         ...
         <0x40000000 &quad_frame_remapper_0 0x40000000 0x10000>,
         <0x43000000 &axi_vdma_0 0x43000000 0x10000>,
         <0x43c00000 &v_tc_in 0x43c00000 0x10000>,
         <0x43c10000 &v_tc_out 0x43c10000 0x10000>,
         <0x43c20000 &axi_dynclk_0 0x43c20000 0x10000>,
